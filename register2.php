...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6 mt-4">
            ...
            <hr>
            <form action="code2.php" method="POST" class="registration-form" autocomplete="off">
                <center>
                    ...
                    <!-- Select Type of Person (Admin, User, Artist) -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" name="save_push_data" class="btn btn-primary">Register</button>
                    </div>
                </center>
            </form>
        </div>
